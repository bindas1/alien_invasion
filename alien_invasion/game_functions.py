...
def fire_bullet(ai_sets, screen, ship, bullets):
    ...
    if len(bullets) < ai_sets.bullets_allowed:
...
def check_events(ai_sets, screen, stats, play_button, ship, bullets):
...
def update_screen(ai_sets, screen, stats, ship, aliens, bullets, play_button):
...
def update_bullets(ai_sets, screen, ship, aliens, bullets):
...
def create_fleet(ai_sets, screen, aliens):
...
def get_number_rows(ai_sets, ship_height, alien_height):
    ...
    available_space_y = (ai_sets.screen_height -
...
def ship_hit(ai_sets, stats, screen, ship, aliens, bullets):
...
def check_aliens_bottom(ai_sets, stats, screen, ship, aliens, bullets):
    """Check if any aliens have reached the bottom of the screen."""
    screen_rect = screen.get_rect()
    for alien in aliens.sprites():
        if alien.rect.bottom >= screen_rect.bottom:
            # Treat this the same as if the ship got hit.
            ship_hit(ai_sets, stats, screen, ship, aliens, bullets)
            break
            
    
def update_aliens(ai_sets, stats, screen, ship, aliens, bullets):
    """
    ...
    check_aliens_bottom(ai_sets, stats, screen, ship, aliens, bullets)
